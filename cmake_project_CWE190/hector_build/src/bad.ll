; ModuleID = '../src/bad.cpp'
source_filename = "../src/bad.cpp"
...
define internal void @__cxx_global_var_init() #0 section ".text.startup" !dbg !953 {
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* @_ZStL8__ioinit), !dbg !955
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i32 0, i32 0), i8* @__dso_handle) #3, !dbg !955
  ret void, !dbg !955
}
...
define dso_local void @_Z16printHexCharLinec(i8 signext %0) #4 !dbg !956 {
  %2 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  call void @llvm.dbg.declare(metadata i8* %2, metadata !959, metadata !DIExpression()), !dbg !960
  %3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt3hexRSt8ios_base), !dbg !961
  %4 = load i8, i8* %2, align 1, !dbg !962
  %5 = sext i8 %4 to i32, !dbg !962
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %3, i32 %5), !dbg !963
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %6, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !964
  ret void, !dbg !965
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local dereferenceable(216) %"class.std::ios_base"* @_ZSt3hexRSt8ios_base(%"class.std::ios_base"* dereferenceable(216) %0) #4 comdat !dbg !966 {
  %2 = alloca %"class.std::ios_base"*, align 8
  store %"class.std::ios_base"* %0, %"class.std::ios_base"** %2, align 8
  call void @llvm.dbg.declare(metadata %"class.std::ios_base"** %2, metadata !970, metadata !DIExpression()), !dbg !971
  %3 = load %"class.std::ios_base"*, %"class.std::ios_base"** %2, align 8, !dbg !972
  %4 = call i32 @_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_(%"class.std::ios_base"* %3, i32 8, i32 74), !dbg !973
  %5 = load %"class.std::ios_base"*, %"class.std::ios_base"** %2, align 8, !dbg !974
  ret %"class.std::ios_base"* %5, !dbg !975
}
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z7goodG2Bv() #4 !dbg !976 {
  %1 = alloca i8, align 1
  %2 = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %1, metadata !977, metadata !DIExpression()), !dbg !978
  store i8 32, i8* %1, align 1, !dbg !979
  store i8 2, i8* %1, align 1, !dbg !980
  call void @llvm.dbg.declare(metadata i8* %2, metadata !981, metadata !DIExpression()), !dbg !983
  %3 = load i8, i8* %1, align 1, !dbg !984
  %4 = sext i8 %3 to i32, !dbg !984
  %5 = add nsw i32 %4, 1, !dbg !985
  %6 = trunc i32 %5 to i8, !dbg !984
  store i8 %6, i8* %2, align 1, !dbg !983
  %7 = load i8, i8* %2, align 1, !dbg !986
  call void @_Z16printHexCharLinec(i8 signext %7), !dbg !987
  ret void, !dbg !988
}

; Function Attrs: noinline optnone uwtable
define dso_local void @_Z7goodB2Gv() #4 !dbg !989 {
  %1 = alloca i8, align 1
  %2 = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %1, metadata !990, metadata !DIExpression()), !dbg !991
  store i8 32, i8* %1, align 1, !dbg !992
  %3 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, i8* dereferenceable(1) %1), !dbg !993
  %4 = load i8, i8* %1, align 1, !dbg !994
  %5 = sext i8 %4 to i32, !dbg !994
  %6 = icmp slt i32 %5, 127, !dbg !996
  br i1 %6, label %7, label %13, !dbg !997

7:                                                ; preds = %0
  call void @llvm.dbg.declare(metadata i8* %2, metadata !998, metadata !DIExpression()), !dbg !1000
  %8 = load i8, i8* %1, align 1, !dbg !1001
  %9 = sext i8 %8 to i32, !dbg !1001
  %10 = add nsw i32 %9, 1, !dbg !1002
  %11 = trunc i32 %10 to i8, !dbg !1001
  store i8 %11, i8* %2, align 1, !dbg !1000
  %12 = load i8, i8* %2, align 1, !dbg !1003
  call void @_Z16printHexCharLinec(i8 signext %12), !dbg !1004
  br label %16, !dbg !1005

13:                                               ; preds = %0
  %14 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str, i64 0, i64 0)), !dbg !1006
  %15 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %14, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !1008
  br label %16
...
define dso_local i32 @main() #6 !dbg !1010 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0)), !dbg !1011
  %3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %2, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !1012
  call void @_Z7goodG2Bv(), !dbg !1013
  call void @_Z7goodB2Gv(), !dbg !1014
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0)), !dbg !1015
  %5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %4, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !1016
  ret i32 0, !dbg !1017
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_(%"class.std::ios_base"* %0, i32 %1, i32 %2) #4 comdat align 2 !dbg !1018 {
  %4 = alloca %"class.std::ios_base"*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  store %"class.std::ios_base"* %0, %"class.std::ios_base"** %4, align 8
  call void @llvm.dbg.declare(metadata %"class.std::ios_base"** %4, metadata !1024, metadata !DIExpression()), !dbg !1026
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1027, metadata !DIExpression()), !dbg !1028
  store i32 %2, i32* %6, align 4
  call void @llvm.dbg.declare(metadata i32* %6, metadata !1029, metadata !DIExpression()), !dbg !1030
  %8 = load %"class.std::ios_base"*, %"class.std::ios_base"** %4, align 8
  call void @llvm.dbg.declare(metadata i32* %7, metadata !1031, metadata !DIExpression()), !dbg !1032
  %9 = getelementptr inbounds %"class.std::ios_base", %"class.std::ios_base"* %8, i32 0, i32 3, !dbg !1033
  %10 = load i32, i32* %9, align 8, !dbg !1033
  store i32 %10, i32* %7, align 4, !dbg !1032
  %11 = load i32, i32* %6, align 4, !dbg !1034
  %12 = call i32 @_ZStcoSt13_Ios_Fmtflags(i32 %11), !dbg !1035
  %13 = getelementptr inbounds %"class.std::ios_base", %"class.std::ios_base"* %8, i32 0, i32 3, !dbg !1036
  %14 = call dereferenceable(4) i32* @_ZStaNRSt13_Ios_FmtflagsS_(i32* dereferenceable(4) %13, i32 %12), !dbg !1037
  %15 = load i32, i32* %5, align 4, !dbg !1038
  %16 = load i32, i32* %6, align 4, !dbg !1039
  %17 = call i32 @_ZStanSt13_Ios_FmtflagsS_(i32 %15, i32 %16), !dbg !1040
  %18 = getelementptr inbounds %"class.std::ios_base", %"class.std::ios_base"* %8, i32 0, i32 3, !dbg !1041
  %19 = call dereferenceable(4) i32* @_ZStoRRSt13_Ios_FmtflagsS_(i32* dereferenceable(4) %18, i32 %17), !dbg !1042
  %20 = load i32, i32* %7, align 4, !dbg !1043
  ret i32 %20, !dbg !1044
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZStaNRSt13_Ios_FmtflagsS_(i32* dereferenceable(4) %0, i32 %1) #4 comdat !dbg !1045 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
  call void @llvm.dbg.declare(metadata i32** %3, metadata !1051, metadata !DIExpression()), !dbg !1052
  store i32 %1, i32* %4, align 4
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1053, metadata !DIExpression()), !dbg !1054
  %5 = load i32*, i32** %3, align 8, !dbg !1055
  %6 = load i32, i32* %5, align 4, !dbg !1055
  %7 = load i32, i32* %4, align 4, !dbg !1056
  %8 = call i32 @_ZStanSt13_Ios_FmtflagsS_(i32 %6, i32 %7), !dbg !1057
  %9 = load i32*, i32** %3, align 8, !dbg !1058
  store i32 %8, i32* %9, align 4, !dbg !1059
  ret i32* %9, !dbg !1060
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @_ZStcoSt13_Ios_Fmtflags(i32 %0) #7 comdat !dbg !1061 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  call void @llvm.dbg.declare(metadata i32* %2, metadata !1064, metadata !DIExpression()), !dbg !1065
  %3 = load i32, i32* %2, align 4, !dbg !1066
  %4 = xor i32 %3, -1, !dbg !1067
  ret i32 %4, !dbg !1068
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZStoRRSt13_Ios_FmtflagsS_(i32* dereferenceable(4) %0, i32 %1) #4 comdat !dbg !1069 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
  call void @llvm.dbg.declare(metadata i32** %3, metadata !1070, metadata !DIExpression()), !dbg !1071
  store i32 %1, i32* %4, align 4
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1072, metadata !DIExpression()), !dbg !1073
  %5 = load i32*, i32** %3, align 8, !dbg !1074
  %6 = load i32, i32* %5, align 4, !dbg !1074
  %7 = load i32, i32* %4, align 4, !dbg !1075
  %8 = call i32 @_ZStorSt13_Ios_FmtflagsS_(i32 %6, i32 %7), !dbg !1076
  %9 = load i32*, i32** %3, align 8, !dbg !1077
  store i32 %8, i32* %9, align 4, !dbg !1078
  ret i32* %9, !dbg !1079
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @_ZStanSt13_Ios_FmtflagsS_(i32 %0, i32 %1) #7 comdat !dbg !1080 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  call void @llvm.dbg.declare(metadata i32* %3, metadata !1083, metadata !DIExpression()), !dbg !1084
  store i32 %1, i32* %4, align 4
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1085, metadata !DIExpression()), !dbg !1086
  %5 = load i32, i32* %3, align 4, !dbg !1087
  %6 = load i32, i32* %4, align 4, !dbg !1088
  %7 = and i32 %5, %6, !dbg !1089
  ret i32 %7, !dbg !1090
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @_ZStorSt13_Ios_FmtflagsS_(i32 %0, i32 %1) #7 comdat !dbg !1091 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  call void @llvm.dbg.declare(metadata i32* %3, metadata !1092, metadata !DIExpression()), !dbg !1093
  store i32 %1, i32* %4, align 4
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1094, metadata !DIExpression()), !dbg !1095
  %5 = load i32, i32* %3, align 4, !dbg !1096
  %6 = load i32, i32* %4, align 4, !dbg !1097
  %7 = or i32 %5, %6, !dbg !1098
  ret i32 %7, !dbg !1099
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_bad.cpp() #0 section ".text.startup" !dbg !1100 {
  call void @__cxx_global_var_init(), !dbg !1102
  ret void
}
...
!30 = !{!31}
!31 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "_Ios_Fmtflags", scope: !2, file: !5, line: 57, baseType: !11, size: 32, elements: !32, identifier: "_ZTSSt13_Ios_Fmtflags")
...
!91 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !90, line: 4, flags: DIFlagFwdDecl, identifier: "_ZTS8_IO_FILE")
...
!230 = !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !81, line: 83, flags: DIFlagFwdDecl, identifier: "_ZTS2tm")
...
!493 = !DICompositeType(tag: DW_TAG_structure_type, name: "lconv", file: !494, line: 51, flags: DIFlagFwdDecl, identifier: "_ZTS5lconv")
...
!548 = !DICompositeType(tag: DW_TAG_structure_type, file: !544, line: 58, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!731 = !DICompositeType(tag: DW_TAG_structure_type, name: "_G_fpos_t", file: !730, line: 10, flags: DIFlagFwdDecl, identifier: "_ZTS9_G_fpos_t")
...
!952 = !{!"clang version 10.0.0 "}
!953 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !3, file: !3, line: 74, type: !558, scopeLine: 74, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !28, retainedNodes: !954)
!954 = !{}
!955 = !DILocation(line: 74, column: 25, scope: !953)
!956 = distinct !DISubprogram(name: "printHexCharLine", linkageName: "_Z16printHexCharLinec", scope: !29, file: !29, line: 4, type: !957, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!957 = !DISubroutineType(types: !958)
!958 = !{null, !72}
!959 = !DILocalVariable(name: "c", arg: 1, scope: !956, file: !29, line: 4, type: !72)
!960 = !DILocation(line: 4, column: 28, scope: !956)
!961 = !DILocation(line: 6, column: 15, scope: !956)
!962 = !DILocation(line: 6, column: 47, scope: !956)
!963 = !DILocation(line: 6, column: 27, scope: !956)
!964 = !DILocation(line: 6, column: 50, scope: !956)
!965 = !DILocation(line: 7, column: 1, scope: !956)
!966 = distinct !DISubprogram(name: "hex", linkageName: "_ZSt3hexRSt8ios_base", scope: !2, file: !5, line: 1036, type: !967, scopeLine: 1037, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!967 = !DISubroutineType(types: !968)
!968 = !{!969, !969}
!969 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !6, size: 64)
!970 = !DILocalVariable(name: "__base", arg: 1, scope: !966, file: !5, line: 1036, type: !969)
!971 = !DILocation(line: 1036, column: 17, scope: !966)
!972 = !DILocation(line: 1038, column: 5, scope: !966)
!973 = !DILocation(line: 1038, column: 12, scope: !966)
!974 = !DILocation(line: 1039, column: 12, scope: !966)
!975 = !DILocation(line: 1039, column: 5, scope: !966)
!976 = distinct !DISubprogram(name: "goodG2B", linkageName: "_Z7goodG2Bv", scope: !29, file: !29, line: 9, type: !558, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!977 = !DILocalVariable(name: "data", scope: !976, file: !29, line: 11, type: !72)
!978 = !DILocation(line: 11, column: 10, scope: !976)
!979 = !DILocation(line: 12, column: 10, scope: !976)
!980 = !DILocation(line: 14, column: 10, scope: !976)
!981 = !DILocalVariable(name: "result", scope: !982, file: !29, line: 17, type: !72)
!982 = distinct !DILexicalBlock(scope: !976, file: !29, line: 15, column: 5)
!983 = !DILocation(line: 17, column: 14, scope: !982)
!984 = !DILocation(line: 17, column: 23, scope: !982)
!985 = !DILocation(line: 17, column: 28, scope: !982)
!986 = !DILocation(line: 18, column: 26, scope: !982)
!987 = !DILocation(line: 18, column: 9, scope: !982)
!988 = !DILocation(line: 20, column: 1, scope: !976)
!989 = distinct !DISubprogram(name: "goodB2G", linkageName: "_Z7goodB2Gv", scope: !29, file: !29, line: 22, type: !558, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!990 = !DILocalVariable(name: "data", scope: !989, file: !29, line: 24, type: !72)
!991 = !DILocation(line: 24, column: 10, scope: !989)
!992 = !DILocation(line: 25, column: 10, scope: !989)
!993 = !DILocation(line: 27, column: 14, scope: !989)
!994 = !DILocation(line: 29, column: 9, scope: !995)
!995 = distinct !DILexicalBlock(scope: !989, file: !29, line: 29, column: 9)
!996 = !DILocation(line: 29, column: 14, scope: !995)
!997 = !DILocation(line: 29, column: 9, scope: !989)
!998 = !DILocalVariable(name: "result", scope: !999, file: !29, line: 31, type: !72)
!999 = distinct !DILexicalBlock(scope: !995, file: !29, line: 30, column: 5)
!1000 = !DILocation(line: 31, column: 14, scope: !999)
!1001 = !DILocation(line: 31, column: 23, scope: !999)
!1002 = !DILocation(line: 31, column: 28, scope: !999)
!1003 = !DILocation(line: 32, column: 26, scope: !999)
!1004 = !DILocation(line: 32, column: 9, scope: !999)
!1005 = !DILocation(line: 33, column: 5, scope: !999)
!1006 = !DILocation(line: 36, column: 19, scope: !1007)
!1007 = distinct !DILexicalBlock(scope: !995, file: !29, line: 35, column: 5)
!1008 = !DILocation(line: 36, column: 78, scope: !1007)
!1009 = !DILocation(line: 38, column: 1, scope: !989)
!1010 = distinct !DISubprogram(name: "main", scope: !29, file: !29, line: 40, type: !641, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1011 = !DILocation(line: 42, column: 15, scope: !1010)
!1012 = !DILocation(line: 42, column: 38, scope: !1010)
!1013 = !DILocation(line: 43, column: 5, scope: !1010)
!1014 = !DILocation(line: 44, column: 5, scope: !1010)
!1015 = !DILocation(line: 45, column: 15, scope: !1010)
!1016 = !DILocation(line: 45, column: 34, scope: !1010)
!1017 = !DILocation(line: 46, column: 5, scope: !1010)
!1018 = distinct !DISubprogram(name: "setf", linkageName: "_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_", scope: !6, file: !5, line: 675, type: !1019, scopeLine: 676, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, declaration: !1023, retainedNodes: !954)
!1019 = !DISubroutineType(types: !1020)
!1020 = !{!1021, !1022, !1021, !1021}
!1021 = !DIDerivedType(tag: DW_TAG_typedef, name: "fmtflags", scope: !6, file: !5, line: 323, baseType: !31)
!1022 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !6, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1023 = !DISubprogram(name: "setf", linkageName: "_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_", scope: !6, file: !5, line: 675, type: !1019, scopeLine: 675, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1024 = !DILocalVariable(name: "this", arg: 1, scope: !1018, type: !1025, flags: DIFlagArtificial | DIFlagObjectPointer)
!1025 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !6, size: 64)
!1026 = !DILocation(line: 0, scope: !1018)
!1027 = !DILocalVariable(name: "__fmtfl", arg: 2, scope: !1018, file: !5, line: 675, type: !1021)
!1028 = !DILocation(line: 675, column: 19, scope: !1018)
!1029 = !DILocalVariable(name: "__mask", arg: 3, scope: !1018, file: !5, line: 675, type: !1021)
!1030 = !DILocation(line: 675, column: 37, scope: !1018)
!1031 = !DILocalVariable(name: "__old", scope: !1018, file: !5, line: 677, type: !1021)
!1032 = !DILocation(line: 677, column: 16, scope: !1018)
!1033 = !DILocation(line: 677, column: 24, scope: !1018)
!1034 = !DILocation(line: 678, column: 20, scope: !1018)
!1035 = !DILocation(line: 678, column: 19, scope: !1018)
!1036 = !DILocation(line: 678, column: 7, scope: !1018)
!1037 = !DILocation(line: 678, column: 16, scope: !1018)
!1038 = !DILocation(line: 679, column: 20, scope: !1018)
!1039 = !DILocation(line: 679, column: 30, scope: !1018)
!1040 = !DILocation(line: 679, column: 28, scope: !1018)
!1041 = !DILocation(line: 679, column: 7, scope: !1018)
!1042 = !DILocation(line: 679, column: 16, scope: !1018)
!1043 = !DILocation(line: 680, column: 14, scope: !1018)
!1044 = !DILocation(line: 680, column: 7, scope: !1018)
!1045 = distinct !DISubprogram(name: "operator&=", linkageName: "_ZStaNRSt13_Ios_FmtflagsS_", scope: !2, file: !5, line: 103, type: !1046, scopeLine: 104, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1046 = !DISubroutineType(types: !1047)
!1047 = !{!1048, !1050, !31}
!1048 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1049, size: 64)
!1049 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !31)
!1050 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !31, size: 64)
!1051 = !DILocalVariable(name: "__a", arg: 1, scope: !1045, file: !5, line: 103, type: !1050)
!1052 = !DILocation(line: 103, column: 29, scope: !1045)
!1053 = !DILocalVariable(name: "__b", arg: 2, scope: !1045, file: !5, line: 103, type: !31)
!1054 = !DILocation(line: 103, column: 48, scope: !1045)
!1055 = !DILocation(line: 104, column: 18, scope: !1045)
!1056 = !DILocation(line: 104, column: 24, scope: !1045)
!1057 = !DILocation(line: 104, column: 22, scope: !1045)
!1058 = !DILocation(line: 104, column: 12, scope: !1045)
!1059 = !DILocation(line: 104, column: 16, scope: !1045)
!1060 = !DILocation(line: 104, column: 5, scope: !1045)
!1061 = distinct !DISubprogram(name: "operator~", linkageName: "_ZStcoSt13_Ios_Fmtflags", scope: !2, file: !5, line: 95, type: !1062, scopeLine: 96, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1062 = !DISubroutineType(types: !1063)
!1063 = !{!31, !31}
!1064 = !DILocalVariable(name: "__a", arg: 1, scope: !1061, file: !5, line: 95, type: !31)
!1065 = !DILocation(line: 95, column: 27, scope: !1061)
!1066 = !DILocation(line: 96, column: 44, scope: !1061)
!1067 = !DILocation(line: 96, column: 26, scope: !1061)
!1068 = !DILocation(line: 96, column: 5, scope: !1061)
!1069 = distinct !DISubprogram(name: "operator|=", linkageName: "_ZStoRRSt13_Ios_FmtflagsS_", scope: !2, file: !5, line: 99, type: !1046, scopeLine: 100, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1070 = !DILocalVariable(name: "__a", arg: 1, scope: !1069, file: !5, line: 99, type: !1050)
!1071 = !DILocation(line: 99, column: 29, scope: !1069)
!1072 = !DILocalVariable(name: "__b", arg: 2, scope: !1069, file: !5, line: 99, type: !31)
!1073 = !DILocation(line: 99, column: 48, scope: !1069)
!1074 = !DILocation(line: 100, column: 18, scope: !1069)
!1075 = !DILocation(line: 100, column: 24, scope: !1069)
!1076 = !DILocation(line: 100, column: 22, scope: !1069)
!1077 = !DILocation(line: 100, column: 12, scope: !1069)
!1078 = !DILocation(line: 100, column: 16, scope: !1069)
!1079 = !DILocation(line: 100, column: 5, scope: !1069)
!1080 = distinct !DISubprogram(name: "operator&", linkageName: "_ZStanSt13_Ios_FmtflagsS_", scope: !2, file: !5, line: 83, type: !1081, scopeLine: 84, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1081 = !DISubroutineType(types: !1082)
!1082 = !{!31, !31, !31}
!1083 = !DILocalVariable(name: "__a", arg: 1, scope: !1080, file: !5, line: 83, type: !31)
!1084 = !DILocation(line: 83, column: 27, scope: !1080)
!1085 = !DILocalVariable(name: "__b", arg: 2, scope: !1080, file: !5, line: 83, type: !31)
!1086 = !DILocation(line: 83, column: 46, scope: !1080)
!1087 = !DILocation(line: 84, column: 43, scope: !1080)
!1088 = !DILocation(line: 84, column: 67, scope: !1080)
!1089 = !DILocation(line: 84, column: 48, scope: !1080)
!1090 = !DILocation(line: 84, column: 5, scope: !1080)
!1091 = distinct !DISubprogram(name: "operator|", linkageName: "_ZStorSt13_Ios_FmtflagsS_", scope: !2, file: !5, line: 87, type: !1081, scopeLine: 88, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1092 = !DILocalVariable(name: "__a", arg: 1, scope: !1091, file: !5, line: 87, type: !31)
!1093 = !DILocation(line: 87, column: 27, scope: !1091)
!1094 = !DILocalVariable(name: "__b", arg: 2, scope: !1091, file: !5, line: 87, type: !31)
!1095 = !DILocation(line: 87, column: 46, scope: !1091)
!1096 = !DILocation(line: 88, column: 43, scope: !1091)
!1097 = !DILocation(line: 88, column: 67, scope: !1091)
!1098 = !DILocation(line: 88, column: 48, scope: !1091)
!1099 = !DILocation(line: 88, column: 5, scope: !1091)
!1100 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_bad.cpp", scope: !29, file: !29, type: !1101, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !28, retainedNodes: !954)
!1101 = !DISubroutineType(types: !954)
